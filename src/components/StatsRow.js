        ...
        <>
            ...
            >
                <div
                    ...
                    <div className="bg-zinc-700 ratingAnimationYellow w-[100px] p-4">${parseFloat(props.latestPrice).toFixed(2)}
                    <br></br>SSE{props.lastSalePrice}
                    </div>
                    <div className="flex-col pt-1 w-[60px] divide-solid divide-y-[1px] divide-black">
                        ...
                        <br></br>{'SSE size'+props.lastSaleSize}
                        </div>
                    </div>
