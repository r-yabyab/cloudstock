            ...
            <div className="relative text-center pt-10 max-w-[800px] m-auto ">
                ...
                <div className=" text-center max-md:w-[450px] md:w-[600px] [&>div]:text-left m-auto justify-center">
                    ...
                    <div className="relative md:mt-72 max-md:mt-40 select-none">
                        ...
                        <div className="text-white">03/06/23 - Problem where live data will mostly show a single update from 2 days ago, actual live data only appears when you refresh the page several times. Same result occurs in local environment and in server... currently in contact with API provider to find problem.</div>
